        ...
        public void StructureFile(string path)
        {
                ...
                else
                {
                    ...
                    if (!algorithmsList.Contains(algorithmStats[0]))
                    {
                        ...
                        Console.WriteLine("Alg: " + algData[0] + " ; AllowdropNodes:" + algData[1] + " ; Feasible: " +
                                          ...
                                          algData[4] + " ; ObjValue: " + algData[5] + " ; MaxUpperBound: " +
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                if (j == 0)
                {
                    ...
                    string firstLine = "AlgId, AllowdropNodes,Feasible,SearchTime,ComputationTime,ObjValue,MaxUpperBound,TotalServedCustomers,TotalDistance,TotalTime, VehiclesUsed, DatasetId";
